<?php 
    ...
    if (!isset($_SESSION['userlogin'])){
        ...
        $nama = ($_SESSION['user'].' '.$_SESSION['namabelakang']);
					...
					<div class="contact-form">
						<form class="form-style-1 row" action="proses/tambahlaporan.php" method="POST" enctype="multipart/form-data">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <input type="hidden" name="namapelapor" value="<?php echo $nama; ?>">
                                <input type="hidden" name="userid" value="<?php echo $_SESSION['id']; ?>">
                                
                                <button type="submit" title="Submit Laporan"><i class="fa fa-envelope" aria-hidden="true"></i> tambahkan laporan</button>
